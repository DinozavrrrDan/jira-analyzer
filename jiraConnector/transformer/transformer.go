...
func TrasformData(issues models.IssuesList) {
	...
	fmt.Println("10: CreatedTime:      " + transormedIssue[0].CreatedTime.String())
	fmt.Println("11: ClosedTime:      " + transormedIssue[0].ClosedTime.String())
	fmt.Println("12: UpdatedTime:      " + transormedIssue[0].UpdatedTime.String())
}
